<div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-6">
    <div class="float-right">
        <a href="<?php echo base_url() ?>Contacts/showEditVendor?vendorId=<?php echo $vendorDetail[0]['contact_code']?>"><i class="fa fa-edit"></i> Edit Info</a>
...
<div class="col-md-12 col-sm-12 col-xs-12 m-t-20">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <?php echo $vendorDetail[0]['company_name']; ?>
        </div>
    </div>
    <div class="row">
