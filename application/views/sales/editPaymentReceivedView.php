...
<div class="col-md-12 col-sm-12 col-xs-12 p-t-20">
    <form id="paymentReceivedForm" class="form-horizontal" action="<?php echo base_url() ?>Sales/editPaymentReceived" method="post">
        <div class="row">
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" >Customer <span class="danger">*</span></label>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <!--<div class="input-group">-->
                    <input type="text" id="customerDetails" class="form-control" value="<?php echo $paymentDetails[0]['contact_name'] . ' (' . $paymentDetails[0]['customer'] . ')' ?>" readonly>
<!--                        <span class="input-group-btn">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <input type="number" min="0" name="amount" id="amount" value="<?php echo $paymentDetails[0]['amount'] ?>" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="input-group dateTxt">
                        <input type="text" name="paymentDate" id="paymentDate" value="<?php echo $paymentDetails[0]['payment_date'] ?>" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <select class="form-control" name="paymentMode"> 
                        <option value="<?php echo $paymentDetails[0]['payment_mode'] ?>"><?php echo $paymentDetails[0]['payment_mode_title'] ?></option>
                        <?php
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <select class="form-control" name="depositTo"> 
                        <option value="<?php echo $paymentDetails[0]['deposit_to'] ?>"><?php echo $paymentDetails[0]['deposit_to_title'] ?></option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <input type="text" name="referenceNo" class="form-control" value="<?php echo $paymentDetails[0]['dis_reference_no'] ?>">
                </div>
            </div>
            <input type="hidden" id="customerCode" name="customerCode" value="<?php echo $paymentDetails[0]['customer'] ?>" >
            <input type="hidden" name="paymentReceiveCode" value="<?php echo $paymentDetails[0]['payment_receive_code'] ?>">
        </div>
        <div class="row">
            <div class="ln_solid"></div>
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="btn btn-success btn-sm" onclick="editPayment()"><i class="fa fa-check"></i> Save</button>
                    <a href="<?php echo base_url() ?>Sales/showPaymentDetails?paymentCode=<?php echo $paymentDetails[0]['payment_receive_code']?>" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Cancel</a>
                </div>
            </div>
        </div>
    </form>
