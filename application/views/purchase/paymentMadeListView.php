...
?>
            ...
            <form class="hidden" id="statusForm" action="<?php echo base_url() ?>Purchase/invoice" method="post">
...
<script>
    $(document).ready(function () {
        ...
        var paymentTable = $('#payment-datatable').DataTable({
            "bDestroy": true,
            "ajax": BASE_URL + 'Purchase/getPaymentList',
            "deferRender": true,
            "aaSorting": [],
            "columnDefs": [
                {
    ...
    function showPaymentDetails(paymentCode) {
        window.location.href = BASE_URL + "Purchase/showPaymentDetails?paymentCode=" + paymentCode;
    }
</script>
