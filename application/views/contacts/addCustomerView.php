...
<div class="col-md-12 col-sm-12 col-xs-12 m-t-20">
    <form id="customerAddForm" class="form-horizontal form-label-right" action="<?php echo base_url() ?>Contacts/addCustomer" method="POST">
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                <!--<input type="text" name="mobile" id="mobile" required="required" maxlength="11" onchange="mobileNoValidation(this.value, this.id)"  class="form-control col-md-7 col-xs-12">-->
            </div>
            <div class="help-block with-errors"></div>
        </div>
        <div class="form-group has-feedback">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <!--<input type="email" name="email" id="email" class="form-control col-md-7 col-xs-12" onchange="emailValidation(this.value, this.id)">-->
                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
            </div>
            <div class="help-block with-errors"></div>
        </div> 
        ...
        <div class="form-group">
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="button" class="btn btn-success btn-sm" onclick="addCustomer()"><i class="fa fa-check"></i> Save</button>
...
<script>
    ...
    $(function () {
        $('#customerAddForm').validator().on('submit', function (e) {
