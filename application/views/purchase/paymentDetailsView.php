<div class="col-md-12 col-sm-12 col-xs-12 hidden-lg hidden-md hidden-sm">
    <div class="btn-group  btn-group-sm">
        <a href="<?php echo base_url() ?>Purchase/showEditPayment?paymentCode=<?php echo $paymentDetails[0]['payment_made_code'] ?>" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i></a>
    ...
    <a href="<?php echo base_url() ?>Purchase/newPaymentMade" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> New Payment</a>
    <a href="#">Page Help</a>
</div>
<div class="col-md-6 col-sm-6 col-xs-12 hidden-xs col-md-offset-6 col-sm-offset-6">
    <div class="float-right">
        <div class="btn-group  btn-group-sm">
            <a href="<?php echo base_url() ?>Purchase/showEditPayment?paymentCode=<?php echo $paymentDetails[0]['payment_made_code'] ?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-pencil font-15"></i></a>
    ...
    <section class="content invoice">
        <div class="row">
            <div class="col-xs-12 invoice-header">
                <h1>
                    <i class="fa fa-globe"></i> Payment Made 
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                <b>Payment Received <?php echo $paymentDetails[0]['payment_made_code'] ?></b>
            </div>
        </div>
