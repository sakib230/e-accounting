...
<div class="col-md-12 col-sm-12 col-xs-12 p-t-20">
    <form id="invoiceForm" class="form-horizontal" action="<?php echo base_url() ?>Sales/addNewInvoice" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="input-group dateTxt">
                        <input type="text" name="invoiceDate" id="invoiceDate" class="form-control">
            ...
            <div class="" >
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="customerNotes" rows="5" style="resize: none"></textarea>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <button type="button" class="btn btn-success btn-sm" onclick="newInvoice('1')"><i class="fa fa-check"></i> Save</button>
                    <button type="button" class="btn btn-info btn-sm" onclick="newInvoice('2')"><i class="fa fa-check-square"></i> Save & Make Payment</button>
                    <a href="<?php echo base_url() ?>Sales/newInvoice" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Cancel</a>
                </div>
            </div>
        </div>
        ...
        <input type="hidden" id="invoiceTotalAmount">
    </form>
</div>
...
//        var itemDetails = new Array();
    ...
    function newInvoice(invoiceFlag) {
        ...
        var title = "";
        if (invoiceFlag === '1') {
            title = "Do you want to create a new invoice?";
        } else {
            title = "Do you want to create and payment this invoice?";
        }
        ...
        swal({
            ...
            if (invoiceFlag === '1') {
                ...
                $.ajax({
                    type: 'POST',
                    data: {invoiceAmount: $('#invoiceTotalAmount').val(), customer: $('#customerCode').val()},
                    url: '<?php echo base_url() ?>Sales/checkInvoicePaymentWhenCreate',
                    success: function (result) {
                        hideLoader();
                        if (result === '1') {
                            $('#invoiceForm').submit();
                        } else if (result === '3') {
                            window.location.href = BASE_URL + "Sales/newInvoice";
                        } else {
