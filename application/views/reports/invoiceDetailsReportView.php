    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="text-center">
                ...
                <span class="font-20">Invoice Details</span><br>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 m-t-30">
            <table class="table custom-table">
                <thead>
                    <tr>
                        <th class='td-left'>Invoice</th>
                        <th>Customer</th>
                        <th>Invoice Date <br><small><i>yyyy-mm-dd</i></small></th>
                        <th>Due Date <br><small><i>yyyy-mm-dd</i></small></th>
                        <th>Status</th>
                        <th class='td-right'>Invoice Amount<br><small><i>BDT</i></small></th>
                ...
                <tbody>
                    ...
                    foreach ($invoiceDetails as $invoiceDetail) {
                        if ($invoiceDetail['invoice_amount'] == $invoiceDetail['paid_amount']) {
                            $status = '<span class="template-green">Paid</span>';
                        } else {
                            $todayDate = date_create(date('Y-m-d'));
                            $dueDate = date_create($invoiceDetail['due_date']);
                        ...
                        echo "<tr>";
                        echo "<td class='td-left'>$invoiceDetail[invoice_code]</td>";
                        echo "<td class='td-left'>" . $invoiceDetail['customer_name'] . " <small><i>(" . $invoiceDetail['customer_code'] . ")</i></small></td>";
                        echo "<td>$invoiceDetail[invoice_date]</td>";
                        echo "<td>$invoiceDetail[due_date]</td>";
                        echo "<td>$status</td>";
                        echo "<td class='td-right'>" . number_format($invoiceDetail['invoice_amount'], 2) . "</td>";
                        echo "<td class='td-right'>" . number_format(($invoiceDetail['invoice_amount'] - $invoiceDetail['paid_amount']), 2) . "</td>";
                        echo "</tr>";
                        $totalInvoiceAmount = $totalInvoiceAmount + $invoiceDetail['invoice_amount'];
                        $totalDue = $totalDue + $invoiceDetail['invoice_amount'] - $invoiceDetail['paid_amount'];
                        $count++;
                    }
                    ...
                    if (!$count) {
                        ...
                        echo "<td class='td-right' colspan='5'><b>" . number_format($totalInvoiceAmount, 2) . "</b></td>";
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form id="customizeForm" action="<?php echo base_url() ?>Reports/invoiceDetails" method="post">
                                ...
                                <tr id="advanceFilterTr1">
                                    <td class="p-b-15">
                                        <select id="filterType1" class="form-control" onchange="setFilterType('1')">
                                            ...
                                            <option value="5">Invoice No</option>
                                        </select>
                                    </td>
...
<script>
    ...
    function setFilterType(filterTypeSerial) {
        ...
        if (filterType === '2') {
            ...
            elementHtml.name = "invoiceDate" + filterTypeSerial;
            ...
            elementHtml = '<input type="text" name="invoiceNo' + filterTypeSerial + '" class="form-control">';
        } else {
