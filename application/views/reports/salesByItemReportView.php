    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="text-center">
                ...
                <span class="font-20">Sales By Item</span><br>
            ...
            <table class="table custom-table">
                <thead>
                    <tr>
                        ...
                        <th>Item Type</th>
                        <th class='td-right'>Current Sales Price<br><small><i>BDT</i></small></th>
                        <th class='td-right'>Quantity Sold</th>
                ...
                <tbody>
                    ...
                    $totalQuantitySold = 0;
                    $totalPrice = 0;
                    foreach ($saleItemDetails as $saleItemDetail) {
                        echo "<tr>";
                        echo "<td class='td-left'>$saleItemDetail[item_title]</td>";
                        echo "<td>" . ucfirst($saleItemDetail['item_type']) . "</td>";
                        echo "<td class='td-right'>$saleItemDetail[sale_rate]</td>";
                        echo "<td class='td-right'>$saleItemDetail[quantity_sold]</td>";
                        echo "<td class='td-right'>" . number_format($saleItemDetail['amount'], 2) . "</td>";
                        $avaragePrice = $saleItemDetail['amount'] / $saleItemDetail['quantity_sold'];
                        echo "<td class='td-right'>" . number_format($avaragePrice, 2) . "</td>";
                        echo "</tr>";
                        $totalQuantitySold = $totalQuantitySold + $saleItemDetail['quantity_sold'];
                        $totalPrice = $totalPrice + $saleItemDetail['amount'];
                    }
                    ...
                    if (!$saleItemDetails) {
                        ...
                        echo "<td class='td-right' colspan='3'><b>" . number_format($totalQuantitySold, 2) . "</b></td>";
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form id="customizeForm" action="<?php echo base_url() ?>Reports/salesByItem" method="post">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var itemTable = $('#item-datatable').DataTable({
            "bDestroy": true,
            "ajax": '<?php echo base_url() ?>Reports/getItem',
            "deferRender": true,
            "paging": true,
            "dom": "<'row'<'col-sm-12 col-md-12 col-xs-12'l><'col-sm-12 col-md-12 col-xs-12'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12'i><'col-sm-12'p>>",
            "aaSorting": [],
