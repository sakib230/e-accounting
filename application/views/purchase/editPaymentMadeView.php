...
<div class="col-md-12 col-sm-12 col-xs-12 p-t-20">
    <form id="paymentMadeForm" class="form-horizontal" action="<?php echo base_url() ?>Purchase/editPaymentMade" method="post">
        <div class="row">
            <div class="form-group">
                <label class="control-label col-md-2 col-sm-3 col-xs-12" >Vendor <span class="danger">*</span></label>
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <!--<div class="input-group">-->
                    <input type="text" id="vendorDetails" class="form-control" value="<?php echo $paymentDetails[0]['contact_name'] . ' (' . $paymentDetails[0]['vendor'] . ')' ?>" readonly>
<!--                        <span class="input-group-btn">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <select class="form-control" name="paidThrough"> 
                        <option value="<?php echo $paymentDetails[0]['paid_through'] ?>"><?php echo $paymentDetails[0]['paid_through_title'] ?></option>
            ...
            <input type="hidden" id="vendorCode" name="vendorCode" value="<?php echo $paymentDetails[0]['vendor'] ?>" >
            <input type="hidden" name="paymentMadeCode" value="<?php echo $paymentDetails[0]['payment_made_code'] ?>">
        </div>
        <div class="row">
            ...
            <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <a href="<?php echo base_url() ?>Purchase/showPaymentDetails?paymentCode=<?php echo $paymentDetails[0]['payment_made_code']?>" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Cancel</a>
                </div>
            </div>
        </div>
    </form>
